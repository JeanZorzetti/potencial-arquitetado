...
//
// Receita de regeração: viewBox 64x64, centro (32,40), raios ri=14 ro=28;
...
const Logo = ({ className = "h-8 w-8" }: { className?: string }) => (
  <svg viewBox="0 0 64 64" fill="currentColor" className={className} role="img" aria-label="Arquitetura do Potencial">
